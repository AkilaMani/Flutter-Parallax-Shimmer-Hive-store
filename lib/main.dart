...
class _LocationListItemState extends State<LocationListItem> {
  ...
  void _dataLoaded() {
    setState(() {
      ...
      final value = widget.imageUrl;
    
      imagesBox.put(key, value);
      var countryName = imagesBox.get(key);
      var countryImageUrl = imagesBox.get(value);
      print(" From Hive Database  name:$countryName ");
      print(" From Hive Database  image :$countryImageUrl");
  ...
  Widget _buildParallaxBackground(BuildContext context) {
    if (isLoading) {
      return Shimmer.fromColors(
          ...
          child:
              Container(width: 400, color: Colors.greenAccent, height: 300.0));
    } else {
      return Flow(
        ...
        child: Column(
          ...
          children: [
            Shimmer.fromColors(
                ...
                highlightColor: Colors.green[100]!,
                child: Container(
                    width: 100, color: Colors.greenAccent, height: 10)),
            SizedBox(height: 5),
            Shimmer.fromColors(
                baseColor: Colors.green[300]!,
                highlightColor: Colors.green[100]!,
                child:
                    Container(width: 50, color: Colors.greenAccent, height: 8)),
          ],
        ),
      );
    } else {
